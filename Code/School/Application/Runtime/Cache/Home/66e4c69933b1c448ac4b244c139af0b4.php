				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1" placeholder="学科名称" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-2">基本描述</label>

							<div class="col-sm-9">
								<input type="text" id="form-field-2" placeholder="描述" class="col-xs-10 col-sm-5" />
							</div>
						</div>
