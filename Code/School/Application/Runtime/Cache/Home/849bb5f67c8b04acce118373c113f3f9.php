				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1_1" placeholder="账号" class="col-xs-10 col-sm-5" />
							</div>
						</div>
							...
							<div class="col-sm-9">
								<input type="password" id="form-field-2" placeholder="密码" class="col-xs-10 col-sm-5" />
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">不填写，默认密码为111111</span>
											</span>
							</div>
						</div>
						<div class="space-4"></div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-select-1_3"> 性别</label>

							<div class="col-sm-9">
								<select class="col-sm-3 control-label no-padding-right" id="form-field-select-1_3">
						...
						<div class="space-4"></div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-select-1_1"> 职位</label>

							<div class="col-sm-9">
								<select class="col-sm-3 control-label no-padding-right" id="form-field-select-1_1">
									<option value="">&nbsp;</option>
						...
						<div class="space-4"></div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-select-1_1"> 教师职称 </label>

							<div class="col-sm-9">
								<select class="col-sm-3 control-label no-padding-right" id="form-field-select-1_2">
									<option value="">&nbsp;</option>
									<option value="AL">Alabama</option>
									<option value="AK">Alaska</option>
									<option value="AZ">Arizona</option>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 学科</label>
